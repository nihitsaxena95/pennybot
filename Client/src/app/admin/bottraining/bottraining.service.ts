...
getRelatedEntity(intentName:any){
  console.log('jkdgfkl',intentName)
  let url:any = config.ip+"/train_intent/getRelatedEntity";
     return this.http.post(url,{intentName})
    .map((res:Response) =>{
     console.log("in response from server ",res);
      return res.json();
    })
}

addMoreSynonym(synonymname:any,intentName:any){
  console.log('my synonym:',synonymname)
...
deleteSynonym(synonymname:any,intentname:any){
  console.log('my deletesynonym:',synonymname,intentname)
